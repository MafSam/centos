...
%define pkgrelease 31.hs1.el9

# This is needed to do merge window version magic
%define patchlevel 14

# allow pkg_release to have configurable %%{?dist} tag
%define specrelease 31.hs1%{?buildid}%{?dist}
...
Source0: linux-5.14.0-31.hs1.el9.tar.xz
...
%setup -q -n kernel-5.14.0-31.hs1.el9 -c
mv linux-5.14.0-31.hs1.el9 linux-%{KVERREL}
...
#
%changelog
* Wed Dec 15 2021 Neal Gompa <ngompa@centosproject.org> [5.14.0-31.hs1.el9]
- redhat/configs: Enable the Btrfs file system (Neal Gompa)
- redhat/configs: Enable CONFIG_ZSTD_COMPRESS for ARK/RHEL (Neal Gompa) [2032758]
