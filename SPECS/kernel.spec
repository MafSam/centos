...
%define pkgrelease 44.hs2.el9

# This is needed to do merge window version magic
%define patchlevel 14

# allow pkg_release to have configurable %%{?dist} tag
%define specrelease 44.hs2%{?buildid}%{?dist}
...
Source0: linux-5.14.0-44.hs2.el9.tar.xz
...
%setup -q -n kernel-5.14.0-44.hs2.el9 -c
mv linux-5.14.0-44.hs2.el9 linux-%{KVERREL}
...
#
%changelog
* Tue Jan 18 2022 Neal Gompa <ngompa@centosproject.org> [5.14.0-44.hs2.el9]
...
* Mon Jan 17 2022 Neal Gompa <ngompa@centosproject.org> [5.14.0-44.hs1.el9]
