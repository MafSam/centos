...
Source0: linux-5.14.0-59.hs1.el9.tar.xz
...
%setup -q -n kernel-5.14.0-59.hs1.el9 -c
mv linux-5.14.0-59.hs1.el9 linux-%{KVERREL}
...
#
%changelog
* Sat Feb 12 2022 Neal Gompa <ngompa@centosproject.org> [5.14.0-59.hs1.el9]
