...
%define pkgrelease 43.hs1.el9

# This is needed to do merge window version magic
%define patchlevel 14

# allow pkg_release to have configurable %%{?dist} tag
%define specrelease 43.hs1%{?buildid}%{?dist}
...
Source0: linux-5.14.0-43.hs1.el9.tar.xz
...
%setup -q -n kernel-5.14.0-43.hs1.el9 -c
mv linux-5.14.0-43.hs1.el9 linux-%{KVERREL}
...
#
%changelog
* Sat Jan 15 2022 Neal Gompa <ngompa@centosproject.org> [5.14.0-43.hs1.el9]
